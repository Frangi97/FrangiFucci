...
Maybe trivial assumptions can be omitted?
		\begin{itemize}
			...
			\item \textbf{D8}: The photo of the license plate has to be taken at the moment, is not possible "recycle" old violations
					         photos.
		\end{itemize}
		...
		\subsection{User} 
			...
			\paragraph{Scenarios}
				\subparagraph{Scenario 1}
					Mario, an elder person who has a reserved parking lot, always has to spend time looking for a free
					car park because someone frequently stole the one reserved to him without being sanctioned by
					authorities. With the help of SafeStreet Mario can report the parking thief to authorities and verify
					that he got sanctioned.
					
				\subparagraph{Scenario 2}
					Luigi use very frequently SafeStreet, but he is not sure if what he is doing is considered by authorities,
					thanks to SafeStreets' reports chronology now he is certain on which reports has been useful and which
					were useless.
